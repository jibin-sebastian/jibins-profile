        ...
        <div className="relative z-10 w-full px-4 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              >
                <p className="text-xl sm:text-2xl lg:text-3xl text-blue-400 font-semibold">
              ...
              >
                AI Software Engineer with a passion for solving complex real-world challenges through innovative
                solutions. Continuously staying updated on the latest advancements in AI and machine learning, I aim
                to contribute to a forward-thinking organization that fosters growth and provides opportunities to
                leverage my expertise effectively.
              </motion.p>
              ...
              >
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-slate-800/50 backdrop-blur-sm border border-slate-700 text-white font-semibold rounded-xl hover:border-blue-500/50 transition-all duration-300"
                >
                  View GitHub
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-cyan-500/40 transition-all duration-300"
                >
                  AI Services
                </motion.a>
              </motion.div>
              ...
              >
                {[
                  ...
                  <motion.a
                    ...
                    href={social.href}
                    whileHover={{ y: -4 }}
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-slate-800/50 backdrop-blur-sm border border-slate-700 flex items-center justify-center hover:border-blue-500/50 transition-all duration-300"
            ...
            {/* Profile Image with Enhanced Parallax and Scale */}
            <motion.div
            ...
            >
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 xl:w-[450px] xl:h-[450px]">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 rounded-full blur-3xl opacity-30"
                />
                <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-slate-800 shadow-2xl">
                  <img src="/image.png" alt="Jibin Sebastian" className="w-full h-full object-cover" />
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="mb-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                ...
                <span className="text-xs sm:text-sm text-blue-400 font-medium">{exp.period}</span>
              </div>
            ...
            <ul className="space-y-2">
              {exp.description.map((item, i) => (
                <li key={i} className="text-slate-300 text-xs sm:text-sm leading-relaxed flex">
